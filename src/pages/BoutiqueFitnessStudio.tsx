...
const BoutiqueFitnessStudio = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#1b2029]">
      ...
      {/* Hero Section */}
      <div className="relative pt-24 min-h-[50vh] flex flex-col bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&q=80")' }}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-end flex-grow relative z-10 pb-16">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/90 mb-6">
              Launch a premium fitness studio offering specialized workouts and personalized training in a boutique setting.
            </p>
            <div className="flex flex-wrap gap-4">
              ...
              <div className="bg-black/30 px-4 py-2 rounded-lg border border-gray-700">
                ...
                <div className="text-lg font-bold text-white">{formatCurrency(75000)} - {formatCurrency(200000)}</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-4xl mx-auto space-y-16">
            ...
            <div className="bg-black/30 p-6 rounded-lg border border-gray-700">
              <div className="space-y-6">
                <p className="text-gray-300">
                  Boutique fitness studios are experiencing rapid growth as health-conscious consumers seek personalized, community-driven workout experiences. This turnkey solution provides everything needed to launch and scale a successful boutique fitness studio.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="p-4 bg-blue-900/20 rounded-lg border border-blue-900/50">
                    ...
                    <p className="text-gray-300 text-sm">Intermediate fitness knowledge</p>
                  </div>
          ...
          <section id="inspiration" className="space-y-8">
            ...
            <div className="bg-black/30 p-6 rounded-lg border border-gray-700">
              <p className="text-gray-300 mb-6">
                Watch success stories and get inspired by entrepreneurs who have built thriving boutique fitness studios.
              </p>
              <VideoSlider category="boutique fitness" />
            </div>
          </section>
              ...
              <div className="bg-black/30 p-6 rounded-lg border border-gray-700">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-2 text-gray-300">
                    ...
                    <span>Growing demand for personalized fitness</span>
                  </li>
                  <li className="flex items-start gap-2 text-gray-300">
                    <CheckCircle2 className="text-green-400 mt-1 flex-shrink-0" size={16} />
                    <span>High-value recurring revenue model</span>
                  </li>
                  <li className="flex items-start gap-2 text-gray-300">
                    <CheckCircle2 className="text-green-400 mt-1 flex-shrink-0" size={16} />
                    <span>Strong community engagement potential</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-black/30 p-6 rounded-lg border border-gray-700">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="text-sm text-gray-400">100-150 members</div>
                  </div>
                  <div>
                    ...
                    <div className="text-sm text-gray-400">250+ members, multiple revenue streams</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-black/30 p-6 rounded-lg border border-gray-700">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">Lease & Buildout</span>
                  <span className="text-white">{formatCurrency(50000)} - {formatCurrency(100000)}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">Equipment</span>
                  <span className="text-white">{formatCurrency(20000)} - {formatCurrency(50000)}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">Licensing/Insurance</span>
                  <span className="text-white">{formatCurrency(5000)} - {formatCurrency(10000)}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">Marketing (Pre-launch)</span>
                ...
                <div className="pt-4 border-t border-gray-700">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-white">{formatCurrency(75000)} - {formatCurrency(200000)}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section id="foundation" className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-black/30 p-6 rounded-lg border border-gray-700">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-blue-900/20 rounded-lg border border-blue-900/50">
                    <h4 className="font-bold text-white mb-2">Monthly Unlimited</h4>
                    <p className="text-gray-300 text-sm">{formatCurrency(150)} - {formatCurrency(300)} per month</p>
                  </div>
                  <div className="p-4 bg-blue-900/20 rounded-lg border border-blue-900/50">
                    <h4 className="font-bold text-white mb-2">Class Packages</h4>
                    <p className="text-gray-300 text-sm">{formatCurrency(100)} - {formatCurrency(200)} per 10 classes</p>
                  </div>
                  <div className="p-4 bg-blue-900/20 rounded-lg border border-blue-900/50">
                    <h4 className="font-bold text-white mb-2">Personal Training</h4>
                    <p className="text-gray-300 text-sm">{formatCurrency(80)} - {formatCurrency(150)} per session</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-black/30 p-6 rounded-lg border border-gray-700">
                ...
                <div className="space-y-4">
                  <div>
                    <div className="text-sm text-gray-400 mb-1">Cardio Equipment</div>
                    <div className="text-white">Treadmills, bikes, rowers</div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-400 mb-1">Strength Equipment</div>
                    <div className="text-white">Free weights, racks, machines</div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-400 mb-1">Studio Equipment</div>
                    <div className="text-white">Mats, bands, accessories</div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">Instagram & Facebook targeting</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="text-green-400 mt-1 flex-shrink-0" size={16} />
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">Local partnerships and events</p>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-black/30 p-6 rounded-lg border border-gray-700">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-blue-900/20 rounded-lg border border-blue-900/50">
                    ...
                    <div className="text-white font-medium">Free Trial Class</div>
                  </div>
                  <div className="p-4 bg-blue-900/20 rounded-lg border border-blue-900/50">
                  ...
                  <div className="p-4 bg-blue-900/20 rounded-lg border border-blue-900/50">
                    ...
                    <div className="text-white font-medium">Membership Sign-up</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-black/30 p-6 rounded-lg border border-gray-700">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-2 text-gray-300">
                    <CheckCircle2 className="text-green-400 mt-1 flex-shrink-0" size={16} />
                    <span>Class scheduling software</span>
                  </li>
                  <li className="flex items-start gap-2 text-gray-300">
                    <CheckCircle2 className="text-green-400 mt-1 flex-shrink-0" size={16} />
              ...
              <div className="bg-black/30 p-6 rounded-lg border border-gray-700">
                ...
                <div className="space-y-4">
                  <div>
                    <div className="text-sm text-gray-400 mb-1">Group Classes</div>
                    <div className="text-xl font-bold text-white">60-70% margin</div>
                  </div>
                  <div>
                    <div className="text-sm text-gray-400 mb-1">Personal Training</div>
          ...
          <section id="risks" className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-black/30 p-6 rounded-lg border border-gray-700">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      <div className="text-white font-medium">High Churn</div>
                      <p className="text-gray-400 text-sm">Focus on community building</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="text-red-400 mt-1 flex-shrink-0" size={16} />
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">Run seasonal challenges</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="text-red-400 mt-1 flex-shrink-0" size={16} />
                    <div>
                      <div className="text-white font-medium">Trainer Turnover</div>
                      <p className="text-gray-400 text-sm">Competitive compensation</p>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-black/30 p-6 rounded-lg border border-gray-700">
                ...
                <div className="p-4 bg-blue-900/20 rounded-lg border border-blue-900/50">
                  <p className="text-gray-300">
                    Add virtual training options and outdoor classes during challenging times. Focus on building a strong community that stays engaged regardless of circumstances.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-blue-900/50 to-purple-900/50 rounded-lg p-8 border border-gray-700">
            <h2 className="text-2xl font-bold text-white mb-4">Ready to Start Your Boutique Fitness Studio?</h2>
            <p className="text-gray-300 mb-6">
              Get everything you need to launch and grow a successful boutique fitness studio. Our turnkey solution includes complete documentation, tools, templates, and expert guidance.
            </p>
...
export default BoutiqueFitnessStudio;